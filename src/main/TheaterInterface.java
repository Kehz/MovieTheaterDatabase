...
public class TheaterInterface {
	...
	public void addTheater() {
		...
		System.out.println("****** Adding a Theater to the Database ******");
	...
	public boolean login() {
		...
		for(User users : userLists) {
			if((users.getUsername() != null && users.getUsername().equalsIgnoreCase(username)) && (users.getPassword() != null && users.getPassword().equalsIgnoreCase(password))) {
