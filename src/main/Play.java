...
public class Play extends Show {
	...
	public Play(int id, String title, int length, String genre, String director, int rating, ArrayList<String> reviews, ArrayList<String> showTimes, ArrayList<String> inTheaters, Boolean[][] seating, int amountActors, int timesPerformed) {
		super(id,title, length, genre, director, rating, reviews, showTimes, inTheaters, seating);
